...
class DomainNet(ImageList):
    ...
    def __init__(self, root: str, task: str, evaluate: Optional[bool] = False,  **kwargs):
        assert task in self.image_list
        phase = "test" if evaluate else "train"
        data_list_file = os.path.join(root, "splits", "{}_{}.txt".format(self.image_list[task], phase))
